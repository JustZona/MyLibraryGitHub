...
import com.example.mylibrary.ViewUtil.AES.misc.BASE64Decoder;
import com.example.mylibrary.ViewUtil.AES.misc.BASE64Encoder;
...
public class MD5 {
    ...
    public static void main(String[] args) {
        MD5 md5 = new MD5();
        String str = md5.encrypt("wxe52967056708e94a");
        System.out.println(str);
        System.out.println(md5.decrypt(str));
    }
}